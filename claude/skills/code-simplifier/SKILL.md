...
description: Review recently modified code and simplify it without changing functionality. Reduces complexity, improves readability, and removes redundancy.
context: fork
allowed-tools: Bash, Glob, Grep, Read, Edit, MultiEdit
---
